                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        int crossAxisCount =
                            (constraints.maxWidth ~/ 80).clamp(2, 4);
                        return GridView.count(
                          ...
                          childAspectRatio: 1,
                          children: [
                            _buildSpecialtyIcon(Icons.medical_services,
                                'General'),
                            _buildSpecialtyIcon(
                                Icons.airline_seat_flat, 'Cardiolo..'),
                            _buildSpecialtyIcon(
                                Icons.remove_red_eye, 'Ophthal..'),
                            _buildSpecialtyIcon(
                                Icons.restaurant, 'Nutritio..'),
                            _buildSpecialtyIcon(Icons.psychology, 'Neurolo..'),
                            _buildSpecialtyIcon(
                                Icons.child_friendly, 'Pediatr..'),
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        int crossAxisCount =
                            (constraints.maxWidth ~/ 100).clamp(2, 4);
                        return GridView.count(
                          crossAxisCount: crossAxisCount,
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          ...
                          children: [
                            _buildCategoryButton(context, 'Foods',
                                FoodsScreen(), emoji: '🥦'),
                            _buildCategoryButton(context, 'Sports',
                                SportsScreen(), emoji: '🏃‍♂️'),
                            _buildCategoryButton(context, 'Health',
                                HealthScreen(), emoji: '💊'),
                          ],
                        );
                      },
  ...
  Widget _buildCategoryButton(BuildContext context, String label, Widget screen,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: const Color.fromARGB(255, 25, 117, 210),
          ),
          borderRadius: BorderRadius.circular(10),
        ),
        child: Center(
